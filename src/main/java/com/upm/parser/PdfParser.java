...
public class PdfParser {
    ...
    public void getTextLineByLineFromReport(String pdfName) {
        PDDocument pdDoc = null;
        PDFTextStripper pdfStripper;
        String parsedText = "";
        File file = new File(pdfName);
    ...
    public void getTextLineByLineFromAgenda(String pdfName) {
        PDDocument pdDoc = null;
        PDFTextStripper pdfStripper;
        String parsedText = "";
        File file = new File(pdfName);
        try {
            ...
            String ods16 = "";
            String ods17 = "";
            while (!lines[i].contains("Poner fin a la pobreza en todas sus formas en todo el")) {
                i++;
            }
            while (!lines[i].contains("Poner fin al hambre, lograr la seguridad alimentaria y la")) {
                if (lines[i].contains("PLAN DE ACCIÓN AGENDA 2030")) {
                    i++;
                    continue;
                }
                ods1 += lines[i];
            ...
            while (!lines[i].contains("Garantizar una vida sana y promover el bienestar de todos")) {
                if (lines[i].contains("PLAN DE ACCIÓN AGENDA 2030")) {
                    i++;
                    continue;
                }
            ...
            while (!lines[i].contains("Garantizar una educación inclusiva y equitativa de calidad y")) {
                if (lines[i].contains("PLAN DE ACCIÓN AGENDA 2030")) {
                    i++;
                    continue;
                }
            ...
            while (!lines[i].contains("Lograr la igualdad de género y empoderar a todas las")) {
                if (lines[i].contains("PLAN DE ACCIÓN AGENDA 2030")) {
                    i++;
                    continue;
                }
            ...
            while (!lines[i].contains("Garantizar la disponibilidad y la gestión sostenible del agua")) {
                if (lines[i].contains("PLAN DE ACCIÓN AGENDA 2030")) {
                    i++;
                    continue;
                }
            ...
            while (!lines[i].contains("Garantizar el acceso a una energía asequible, segura,")) {
                if (lines[i].contains("PLAN DE ACCIÓN AGENDA 2030")) {
                    i++;
                    continue;
                }
            ...
            while (!lines[i].contains("Promover el crecimiento económico sostenido, inclusivo y")) {
                if (lines[i].contains("PLAN DE ACCIÓN AGENDA 2030")) {
                    i++;
                    continue;
                }
            ...
            while (!lines[i].contains("Construir Infraestructuras resilientes, promover la")) {
                if (lines[i].contains("PLAN DE ACCIÓN AGENDA 2030")) {
                    i++;
                    continue;
                }
            ...
            while (!lines[i].contains("Reducir la desigualdad en los países y entre ellos")) {
                if (lines[i].contains("PLAN DE ACCIÓN AGENDA 2030")) {
                    i++;
                    continue;
                }
            ...
            while (!lines[i].contains("Lograr que las ciudades y los asentamientos")) {
                if (lines[i].contains("PLAN DE ACCIÓN AGENDA 2030")) {
                    i++;
                    continue;
                }
            ...
            while (!lines[i].contains("Garantizar modalidades de consumo y producción")) {
                if (lines[i].contains("PLAN DE ACCIÓN AGENDA 2030")) {
                    i++;
                    continue;
                }
            ...
            while (!lines[i].contains("Adoptar medidas urgentes para combatir el")) {
                if (lines[i].contains("PLAN DE ACCIÓN AGENDA 2030")) {
                    i++;
                    continue;
                }
            ...
            while (!lines[i].contains("Conservar y utilizar sosteniblemente los océanos")) {
                if (lines[i].contains("PLAN DE ACCIÓN AGENDA 2030")) {
                    i++;
                    continue;
                }
            ...
            while (!lines[i].contains("Gestionar sosteniblemente los bosques, luchar")) {
                if (lines[i].contains("PLAN DE ACCIÓN AGENDA 2030")) {
                    i++;
                    continue;
                }
            ...
            while (!lines[i].contains("Promover sociedades pacíficas e inclusivas para el")) {
                if (lines[i].contains("PLAN DE ACCIÓN AGENDA 2030")) {
                    i++;
                    continue;
                }
            ...
            while (!lines[i].contains("Fortalecer los medios de implementación y")) {
                if (lines[i].contains("PLAN DE ACCIÓN AGENDA 2030")) {
                    i++;
                    continue;
                }
            ...
            while (!lines[i].contains("3. LA AGENDA 2030 EN EL MARCO MULTILATERAL")) {
                if (lines[i].contains("PLAN DE ACCIÓN AGENDA 2030")) {
                    i++;
                    continue;
                }
